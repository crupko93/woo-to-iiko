...
class KladrApi{
	...
	private function GetURL(QueryKladr $query)
	{
		if (empty($this->token)) {
	 ...
	 * @param \Kladr\QueryKladr $query Объект запроса
	 * @param bool         $assoc Вернуть ответ в виде ассоциативного массива
	 * @return bool|mixed
	 */
	public function QueryToJson(QueryKladr $query, $assoc = FALSE)
	{
	 ...
	 * @return array
	 */
	public function QueryToArray(QueryKladr $query)
	{
	 ...
	 * @return \Kladr\Object[]
	 */
	public function QueryToObjects(QueryKladr $query)
	{
